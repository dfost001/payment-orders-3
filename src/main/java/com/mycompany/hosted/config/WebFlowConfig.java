...
public class WebFlowConfig extends AbstractFlowConfiguration {	
	...
	public ConversionService conversionService() {
		...
		FormattingConversionService formattingSvc = new DefaultFormattingConversionService();
		
		addFormatters(formattingSvc);
		
		ConversionService conversionSvc = new DefaultConversionService(formattingSvc);
